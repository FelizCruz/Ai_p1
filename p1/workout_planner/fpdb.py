...
class FitnessPlannerApp:
    def __init__(self, root, db_name):
        ...
        self.caloric_intake_label.grid(row=2, column=0, padx=10, pady=10, sticky="W")
        self.caloric_intake_entry = ttk.Entry(root)
        self.caloric_intake_entry.grid(row=2, column=1, padx=10, pady=10)

        self.intensity_label = ttk.Label(root, text="Choose your intensity:")
        self.intensity_label.grid(row=3, column=0, padx=10, pady=10, sticky="W")
        ...
        self.low_intensity_radio.grid(row=3, column=1, padx=10, pady=10, sticky="W")
        self.high_intensity_radio = ttk.Radiobutton(root, text="High Intensity", variable=self.intensity_var, value="high")
        self.high_intensity_radio.grid(row=3, column=2, padx=10, pady=10, sticky="W")

        self.plan_button = ttk.Button(root, text="Get Workout Plan", command=self.get_workout_plan)
        self.plan_button.grid(row=4, column=0, columnspan=3, padx=10, pady=20)
